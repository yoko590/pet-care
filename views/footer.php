    ...
    <!-- Footer 2 think background-color later!-->
       <div class="col-12 py-1 pl-2 border-top"> 
           ...
           <div class="float-right">
                <a href="#" style="font-size:20px;"><i class="fab fa-twitter-square text-white mr-2"></i></a>
                <a href="#" style="font-size:20px;"></i><i class="fab fa-facebook-square text-white mr-5"></i></a>
           </div>
       </div>
    </footer>
