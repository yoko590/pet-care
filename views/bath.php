...
<link rel="stylesheet" href="../assets/css/bath.css">

<body>
    <main>
        <section class="text-white" id="showcase">
            <div id="title">
                <p class="display-4 pb-2 font-weight-bold">Bath & Dry</p>
                <h6 class="lead ml-5">Included in Full-Service Bath</h6>
            </div>
        </section>
        ...
        <section class="p-5" id="content2">
             <div class="row container">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <img src="../assets/img/service/pet_bath2.jpg" alt="pet_bath_img" class="w-100 rounded-pill">
                </div>

                <div class="col-sm-12 col-md-6 col-lg-6 text-center">
                    <h5 class="mt-4 mb-4 font-weight-bold">② Bath & Dry</h5>
                    <p class="font-italic"><span class="font-weight-bold">What's Included:</span> Bath, Mango Tango shampoo/conditioner, drying, light brush out, and treat. </p>
                    ...
                    <img src="../assets/img/service/pet_dry.jpg" alt="pet_dryer" class="w-75 rounded-pill mt-4">
                </div>
            </div>
        </section>
